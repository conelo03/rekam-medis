                                ...
                                <div class="card-body">
                                  <div class="table-responsive">
                                    <table class="table table-striped table-bordered" id="table-1">
                                      ...
                                      <tbody>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * FROM riwayat_penyakit WHERE id_pasien='".$tokne['id']."'");
                                        $i = 0;
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td>
                                              <?php
                                              $obat2an = mysqli_query($conn, "SELECT * FROM riwayat_obat WHERE id_penyakit='$idpenyakit' AND id_pasien='".$tokne['id']."'");
