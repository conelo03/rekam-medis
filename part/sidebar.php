...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php echo ($page == "Riwayat Rawat Jalan") ? "class=active" : ""; ?>><a class="nav-link" href="riwayat_rawat_jalan.php"><i class="fas fa-list"></i> <span>Riwayat Rawat Jalan</span></a></li>
